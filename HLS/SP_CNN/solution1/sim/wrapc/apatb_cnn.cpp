...
#define AUTOTB_TVIN_INPUT_r "../tv/cdatafile/c.cnn.autotvin_INPUT_r.dat"
#define AUTOTB_TVOUT_INPUT_r "../tv/cdatafile/c.cnn.autotvout_INPUT_r.dat"
#define AUTOTB_TVIN_OUTPUT_r "../tv/cdatafile/c.cnn.autotvin_OUTPUT_r.dat"
#define AUTOTB_TVOUT_OUTPUT_r "../tv/cdatafile/c.cnn.autotvout_OUTPUT_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_INPUT_r "../tv/rtldatafile/rtl.cnn.autotvout_INPUT_r.dat"
#define AUTOTB_TVOUT_PC_OUTPUT_r "../tv/rtldatafile/rtl.cnn.autotvout_OUTPUT_r.dat"
...
extern "C"
void apatb_cnn_hw(void* __xlx_apatb_param_image_r, void* __xlx_apatb_param_prediction)
{
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_prediction;
  ...
  port1.param = &__xlx_offset_byte_param_prediction;
  ...
  port2.param = { __xlx_apatb_param_image_r };
  port2.nbytes = { 3136 };
  port2.offset = {  };
  ...
  port3.param = { __xlx_apatb_param_prediction };
  port3.nbytes = { 40 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  try {
    ...
    cnn_hw_stub_wrapper(__xlx_apatb_param_image_r, __xlx_apatb_param_prediction);
