...
using hls::sim::Byte;
extern "C" void cnn(Byte<4>*, Byte<4>*, int, int);
extern "C" void apatb_cnn_hw(volatile void * __xlx_apatb_param_image_r, volatile void * __xlx_apatb_param_prediction) {
using hls::sim::createStream;
  // Collect __xlx_image_r__tmp_vec
std::vector<Byte<4>> __xlx_image_r__tmp_vec;
for (size_t i = 0; i < 784; ++i){
__xlx_image_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_image_r)[i]);
}
  int __xlx_size_param_image_r = 784;
  int __xlx_offset_param_image_r = 0;
  int __xlx_offset_byte_param_image_r = 0*4;
...
__xlx_prediction__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_prediction)[i]);
  ...
  // DUT call
  cnn(__xlx_image_r__tmp_vec.data(), __xlx_prediction__tmp_vec.data(), __xlx_offset_byte_param_image_r, __xlx_offset_byte_param_prediction);
// print __xlx_apatb_param_image_r
for (size_t i = 0; i < __xlx_size_param_image_r; ++i) {
((Byte<4>*)__xlx_apatb_param_image_r)[i] = __xlx_image_r__tmp_vec[__xlx_offset_param_image_r+i];
}
